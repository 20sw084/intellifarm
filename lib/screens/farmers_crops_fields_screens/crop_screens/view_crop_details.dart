...
class ViewCropDetails extends StatelessWidget {
                        ...
                        if (snapshot.connectionState ==
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              String varietyName =
                                  firestoreData['varietyName'] ?? '';

                              return FutureBuilder<int>(
                                future: getPlantingsCountBasedOnVariety(
                                    varietyName),
                                builder: (context, plantingSnapshot) {
                                  int plantingsCount =
                                      plantingSnapshot.data ?? 0;
                                  return SizedBox(
                                    width: MediaQuery.of(context).size.width,
                                    height: 220,
                                    child: Card(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            buildInfoRow(
                                                "LightProfile:",
                                                firestoreData['lightProfile']
                                                    .toString()
                                                    .split(".")
                                                    .last),
                                            buildInfoRow(
                                                "Field Type:",
                                                firestoreData['fieldType']
                                                    .toString()
                                                    .split(".")
                                                    .last),
                                            buildInfoRow(
                                                "Days to Maturity:",
                                                firestoreData['daysToMaturity']
                                                    .toString()),
                                            buildInfoRow(
                                                "Harvest Window:",
                                                firestoreData[
                                            ...
                                            buildInfoRow(
                                                "Plantings:",
                                                plantingsCount
                                                    .toString()), // Display the plantings count here
                                            buildInfoRow(
                                                "Notes:",
                                                firestoreData['notes']
                                                    .toString()),
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.connectionState ==
                          ...
                          return ListView.builder(
                            itemCount: documents.length,
                            itemBuilder: (context, index) {
                              firestoreData = documents[index].data()
                                  as Map<String, dynamic>;
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: MediaQuery.of(
                                                            ...
                                                            0.6,
                                                        child: Text(
                                                          "${dataMap["Name:"].toString().split(".").last} :: ${firestoreData?['varietyName']} (${firestoreData?['fieldName']})",
                                                          maxLines: 1,
  ...
  Future getCropPlantingDataViaFuture() async {
    ...
    try {
      String? cropId = await r.getCropIdByName(
        dataMap["Name:"],
      );
      if (id != null) {
        return await r.usersRef
            .doc(id)
            .collection("crops")
            .doc(cropId)
