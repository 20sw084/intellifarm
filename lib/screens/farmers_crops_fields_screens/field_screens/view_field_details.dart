              ...
              IconButton(
                onPressed: (){
                  showMenu(
                    ...
                    switch (value) {
                      case 1:
                        Navigator.push(context, MaterialPageRoute(builder: (context) => EditFieldRecord(field: fieldObject,),));
                        break;
                      case 2:
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AddFieldPlanting(fieldName: dataMap["Name:"],),));
                        break;
                      case 3:
