...
class PlantingsScreen extends StatefulWidget {
  const PlantingsScreen({super.key});

  @override
  State<PlantingsScreen> createState() => _PlantingsScreenState();
}

String isCheckboxChecked = "Last 7 days";

class _PlantingsScreenState extends State<PlantingsScreen> {
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                var plantingData =
                    plantings[index].data() as Map<String, dynamic>;
                        ...
                        children: [
                                  ...
                                  IconButton(
                                      ...
                                      onPressed: () {
                                        showMenu(
                                          ...
                                          switch (value) {
                                            case 1:
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => EditPlanting(cropPlanting: cr),));
                                              break;
                                            case 2:
                                              print('Option 2: View Report: selected');
                                              break;
                                            case 3:
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => AddActivityHarvest(),));
                                              break;
                                            case 4:
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => AddActivityTreatment(),));
                                              break;
                                            case 5:
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => AddActivityTask(),));
                                              break;
                                            case 6:
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                plantingData["quantityPlanted"].toString(),
                                style: TextStyle(
                                  fontSize: 12.5,
                                ),
                              ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                plantingData["estimatedYield"].toString(),
                                style: TextStyle(
                                  fontSize: 12.5,
                                ),
                              ),
